...
class TextEmbedder:
    """
    Text embedder using sentence-transformers for semantic similarity.
    Uses all-MiniLM-L6-v2: lightweight, fast, and CPU-friendly model.
    """
    ...
    def embed_csv(self, csv_path: str, text_column: str = 'Overview', 
...
class TextSimilaritySearch:
    """Semantic text similarity search system."""
    ...
    def build_database(self, csv_path: str, text_column: str = 'Overview', 
                      batch_size: int = 32):
        """
        Build the vector database from a CSV file.
    ...
    def find_similar(self, query_text: str, top_k: int = 10) -> List[Dict]:
        """
        Find similar movies based on text query.
    ...
    def get_all_movies(self) -> List[Dict[str, str]]:
        ...
        Returns:
            List of dictionaries containing title and overview
        """
        return [
            {
                "title": m["title"],
...
if __name__ == "__main__":
    ...
    # Build database from CSV (only need to do this once)
